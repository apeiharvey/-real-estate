    ...
    <div class="card-body">
      <form method="post" action="{{route('testimony.store')}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="testimony_name" placeholder="Enter Name"  value="{{old('testimony_name')}}" class="form-control">
        ...
        <div class="form-group">
          ...
          <textarea id="inputText" name="text" class="form-control">{{old('text')}}</textarea>
          @error('text')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
...
<link rel="stylesheet" href="{{asset('backend/vendor/select2/select2.min.css')}}">
@endpush
@push('scripts')
