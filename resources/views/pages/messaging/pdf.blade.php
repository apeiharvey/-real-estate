        ...
        <div class="card card-custom overflow-hidden">
            ...
            <div class="card-header border-0 py-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label font-weight-bolder text-dark">{{$transcript_title}}</span>
                    <span class="text-muted mt-3 font-weight-bold font-size-sm">Transkrip Pesan</span>
                </h3>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
            <div class="card-body pt-0 pb-3">
                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-head-bg table-vertical-center table-borderless">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="pl-0 py-8">
                                        @if(@$item->from_type == 'MEMBER' && $prev_talker != 'MEMBER')
                                        ...
                                        @elseif(@$item->from_type == 'VENDOR' && $prev_talker != 'VENDOR')
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-50 flex-shrink-0 mr-4">
                                        ...
                                        @elseif(@$item->from_type == 'ADMIN' && $prev_talker != 'ADMIN')
                                        @else
                                        @endif
                                            <?php $prev_talker = $item->from_type; ?>
                                    </td>
                                    <td>
                                        <div class="treat-msg-wrapper">
                                            ...
                                            ?>
                                            <span class="treat-msg" wrap="hard">{!! @$item->message !!}</span>
                                        </div>
                                    </td>
                                    <td>
                ...
                @else
                    <center class="mb-10"><i>permintaan tidak valid</i></center>
                @endif
                <!--end::Table-->
            </div>
            <!--end::Body-->
