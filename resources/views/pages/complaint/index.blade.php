                                ...
                                <div class="d-flex justify-content-center mb-5">
                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                        <label class="btn btn-success btn-lg active">
                                            <input type="radio" name="search_status" data-id="search_status_ongoing" data-status="OPEN"  checked="checked"/> Komplain Aktif
                                        </label>
                                        <label class="btn btn-success btn-lg">
                                            <input type="radio" name="search_status" data-id="search_status_done"  data-status="RESOLVED"/> Komplain Selesai
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="flex-row-fluid ml-lg-8" id="kt_chat_content">
                        ...
                        <div class="card card-custom" id="complaint_row_detail_card">
                            ...
                            <div class="card-header align-items-center px-4 py-3">
                                <div style="display:flex">
                                    ...
                                    <div class="text-right flex-grow-1">
                                        <!--begin::Dropdown Menu-->
                                        <div class="dropdown dropdown-inline">
                                            <div class="btn-group dropleft on-not-blank" id="button-process-action-wrap" style="display:none">
                                                <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    Aksi
                                                </button>
                                                <div class="dropdown-menu">
                                                    <!-- <a class="dropdown-item button-process-complaint" href="#" data-status="close_cancel">Batalkan order</a> -->
                                                    <a class="dropdown-item button-process-complaint" href="#" data-status="close_continue">Tutup komplain dan lanjutkan order</a>
                                                    <a class="dropdown-item button-process-complaint" href="#" data-status="request_admin_help">Ajukan penyelesaian oleh Admin</a>
                                                    <a class="dropdown-item button-process-complaint" href="#" data-status="close_return">Tutup komplain dan batalkan order (Satdik mengembalikan barang)</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!--end::Dropdown Menu-->
                                ...
                                <div class="d-flex justify-content-center on-not-blank" id="button-process-info-wrap" style="display:none"></div>
                            </div>
                            <!--end::Header-->
                            <!--begin::Body-->
                            ...
                            <div class="card-footer align-items-center" style="padding: 0.5rem 2rem !important;">
                                ...
                                <input name="complain_hash" type="text" hidden>
                                <input name="complain_hash_get_url" type="text" value="{{@$_GET['ch']}}" hidden>
                                <input name="order_detail_get_url" type="text" value="{{@$_GET['od']}}" hidden>
                                <!--begin::Compose-->
                                <form id="addForm" onsubmit="return false;">
                                    <textarea name="message" class="add-form-el form-control border-0 p-0 on-not-blank" rows="2" placeholder="Ketik pesan disini ..." required style="display:none"></textarea>
...
@section('admin_js')
    ...
    <script src="{{ asset('js/pages/complaint/index.js') }}?ver=000025"></script>
@endsection
