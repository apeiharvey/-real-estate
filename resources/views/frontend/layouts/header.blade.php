                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            <a href="https://api.whatsapp.com/send?phone={{$settings->phone_2}}" target="_blank">
                                <li><i class="ti-headphone-alt"></i>+{{$settings->phone_2}}</li>
                            </a>
                            <a href="https://api.whatsapp.com/send?phone={{$settings->phone_3}}" target="_blank">
                                <li><i class="ti-headphone-alt"></i>+{{$settings->phone_3}}</li>
                            </a>
                            <a href="https://api.whatsapp.com/send?phone={{$settings->phone_4}}" target="_blank">
                                <li><i class="ti-headphone-alt"></i>+{{$settings->phone_4}}</li>
                            </a>
                        </ul>
                    </div>
                    <!-- Top Right -->
    ...
    <div class="middle-inner">
        <div class="container">
            <div class="row">
                ...
                <div class="search-container col-lg-8 col-md-7 col-12">
