...
@endsection
@section('title','Nadia Baju Anak || PRODUCT DETAIL')
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="product-buy">
												@if(!empty($product_detail->links))
													@foreach($product_detail->links as $link)
														<a href="{{$link->link}}" target="_blank">
															@if($link->type == "tokopedia")
																<button class="btn btn-tokopedia"><img class="mr-2" width="40" height="40" src="{{asset('backend/img/tokopedia-logo.png')}}">{{$link->name}}</button>
															@else
																<button class="btn btn-shopee"><img class="mr-2" width="40" height="40" src="{{asset('backend/img/shopee-logo.jpg')}}">{{$link->name}}</button>
															@endif
														</a>
													@endforeach
												@endif
