<div class="ltn__slider-area ltn__slider-3  section-bg-2">
    <div class="ltn__slide-one-active banner slick-slide-arrow-1 slick-slide-dots-1">
        ...
        <!-- ltn__slide-item -->
        <div class="ltn__slide-item ltn__slide-item-2  ltn__slide-item-3-normal--- ltn__slide-item-3 bg-image bg-overlay-theme-black-60" data-bs-bg="{{asset('frontend/img/slider/13.jpg')}}">
