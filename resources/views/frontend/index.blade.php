                            ...
                            <div class="single-list">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 no-padding">
                                    <div class="content">
                                        ...
                                        @if($product->discount > 0)
                                        <p class="price with-discount">Disc {{number_format($product->discount)}}%</p>
                                        @else
                        ...
                        <div class="content">
                            <div class="heading-block">
                                ...
                                @php 
                                    $after_discount=($product->price-($product->price*$product->discount)/100)
                                @endphp
                                <h1 class="price">Rp. {{number_format($after_discount,0,',','.')}} <s>Rp. {{number_format($data->price,0,',','.')}}</s></h1>
